...
describe 'Need', ->
	...
	describe 'Solids need in kilos', ->
		it "is based on the horse's weight", ->
	...
	describe 'Energy need in MJ is based on', ->
		describe 'feed type', ->
			it 'need for normal horses', ->
				@need.energyInMJ().should.equal 51.29

			it 'need for easily fed horses', ->
				@horse.feedType = 'easy'
				@need.energyInMJ().should.equal 48.85

			it 'need for hard fed horses', ->
				@horse.feedType = 'hard'
	...
	describe 'Protein need in grams', ->
		it 'is energy need times 6', ->
			@need.energyInMJ = -> 50
	...
	describe 'Calcium need in grams', ->
		it "is based on the horse's weight and workload", ->
	...
	describe 'Phosphor need in grams', ->
		it "is based on the horse's weight and workload", ->
			ratios = [0.0, 0.29, 0.49, 0.50]
	...
	describe 'Magnesium need in grams', ->
		it "is based on the horse's weight and workload", ->
			ratios = [0.0, 0.29, 0.49, 0.50]
	...
	describe 'selenium need in milligrams', ->
		it "is based on the horse's weight", ->
	...
	describe 'sufficient amount of nutrients', ->
